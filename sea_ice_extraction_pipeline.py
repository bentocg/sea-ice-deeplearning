...
from utils.training_set_extraction import extract_sea_ice
from utils.training_set_extraction import polygonize_raster
...
class ShapefileWriter:
    def __init__(self, out_shp, crs, sizelimit=None):
        ...
        self.crs = crs
        self.schema = {'geometry': 'Polygon', 'properties': {'area': 'float', 'scene': 'str:150'}}
